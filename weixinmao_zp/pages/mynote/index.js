...
Page((_defineProperty(_Page = {
    ...
    onLoad: function(e) {
        ...
        console.log(t), t && t.hasOwnProperty("wxInfo") ? (a.data.isuser = !0, a.initpage(), 
        a.setData({
            userinfo: t
    ...
    initpage: function() {
        var i = this, e = wx.getStorageSync("cityinfo");
        e ? (wx.setStorageSync("city", e.name), i.oldhouseinit()) : (qqmapsdk = new QQMapWX({
    ...
    oldhouseinit: function(e) {
        var i = this, a = wx.getStorageSync("userInfo"), t = wx.getStorageSync("city");
        app.util.request({
            ...
            success: function(e) {
                if (!e.data.message.errno && 1 == e.data.data.isbind) {
                    ...
                    console.log(t), t && (i.data.jobtitle = t.jobtitle, i.data.birthdayindex = isHasElementOne(i.data.birthday, t.birthday), 
                    i.data.birthdayname = t.birthday, i.data.currentstatusindex = isHasElementOne(i.data.currentstatus, t.currentstatus), 
                    i.data.currentstatusname = t.currentstatus, i.data.jobcateindex = isHasElementTwo(e.data.data.jobcate, t.jobcateid), 
                    ...
                    i.data.moneyname = t.money, i.data.sex = t.sex, i.data.special = t.special), i.setData({
                        ...
                        noteinfo: t,
                        birthdayindex: i.data.birthdayindex,
    ...
    savepubinfo: function(e) {
        ...
        if ("" != n) if (0 != s) if ("" != o) if ("" != r) if ("" != l) if ("" != u) if ("" != c) if ("" != h) if ("" != p) if ("" != f) if (0 != m) if ("" != x) if (0 != w) if ("" != y) {
            ...
            if (g.length < 2) wx.showModal({
                ...
                _defineProperty(a, "jobcateid", m), _defineProperty(a, "money", x), _defineProperty(a, "areaid", w), 
                _defineProperty(a, "content", y), _defineProperty(a, "uploadimagelist_str", v), 
                a);
                app.util.request({
    ...
    bindGetUserInfo: function(e) {
        ...
        app.util.getUserInfo(function(e) {
            console.log(e), a.data.isuser = !0, a.oldhouseinit(), a.setData({
                userinfo: e,
                isuser: a.data.isuser
            });
        }, e.detail);
