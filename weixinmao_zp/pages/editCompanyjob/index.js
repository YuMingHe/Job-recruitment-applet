...
Page((_defineProperty(_Page = {
    ...
    savepubinfo: function(e) {
        var a = this, t = wx.getStorageSync("userInfo"), i = e.detail.value.jobtitle, n = this.data.jobcateid, s = e.detail.value.money, o = e.detail.value.num, d = a.data.educationname, l = a.data.expressname, r = a.data.worktypename, c = e.detail.value.age, u = a.data.sex, p = e.detail.value.content, h = a.data.id;
        if ("" != i) if (0 != n) if ("" != s) if ("" != o) if ("" != d) if ("" != l) if ("" != r) if ("" != c) if ("" != p) {
            var x = {
                sessionid: t.sessionid,
                uid: t.memberInfo.uid,
                id: h,
